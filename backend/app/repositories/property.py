...
class PropertyRepository(IRepository[Property]):
    ...
    @logs
    @with_cursor(model=Property)
    def add(self, object: Property, db = None) -> Property:
        ...
        db.execute(query, (object.price, object.property_type, object.address_id))
        return db.fetchone()
    
    @logs
    @with_cursor(model=Property)
    def modify_by_id(self, object: Property, db = None) -> Property:
        ...
        db.execute(query, (object.price, object.property_type, object.address_id, object.id_property))
        return db.fetchone()
    ...
    @logs
    def get_model_type(self) -> type[Property]:
        return Property